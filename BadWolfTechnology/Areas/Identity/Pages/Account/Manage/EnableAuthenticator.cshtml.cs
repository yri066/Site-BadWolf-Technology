...
namespace BadWolfTechnology.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "Код проверки неверен.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            StatusMessage = "Ваше приложение аутентификатора было подтверждено.";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("BadWolf Technology"),
